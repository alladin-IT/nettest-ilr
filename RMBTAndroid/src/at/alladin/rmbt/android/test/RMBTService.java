...
public class RMBTService extends Service implements EndTaskListener
{
    ...
    public String getTestUuid(boolean removeLastUuid) {
        if (testTask != null) {
            return testTask.getTestUuid();
        }
        else {
            return ConfigHelper.getLastTestUuid(getApplicationContext(), removeLastUuid);
        }
    }
    ...
    public void taskEnded()
    {
        ...
        stopSelf();
        if (testTask != null && this.lastIntermediateResult == null) {
            this.lastIntermediateResult = testTask.getIntermediateResult(null);
