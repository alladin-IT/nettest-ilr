...
public interface GeoLocationView {
    public static enum GeoLocationViewState {
        TURNED_OFF,
        ON_GPS,
        ON_WIFI
    }

    void updateGeoLocationViewState(final GeoLocationViewState state);
    GeoLocationViewState getGeoLocationViewState();

    void updateGeoLocationString(final String gpsString);
