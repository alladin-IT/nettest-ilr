 ...
 *
 */
public class ResultQoSDetailListView extends ScrollView implements EndTaskListener<JSONArray>, OnItemClickListener, OnClickListener {
	 ...
	 * @param jsonArray
	 */
	public ResultQoSDetailListView(Context context, RMBTMainActivity activity, String uid, JSONArray jsonArray) {
	 ...
	 * @param activity2
	 */
	public ResultQoSDetailListView(Context context, AttributeSet attrs, RMBTMainActivity activity, String uid, JSONArray jsonArray) {
		super(context, attrs);
	...
	{
		final View view = inflater.inflate(R.layout.result_qos_details_list, this);
