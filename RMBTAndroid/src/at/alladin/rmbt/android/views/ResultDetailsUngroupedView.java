...
public class ResultDetailsUngroupedView extends LinearLayout implements EndTaskListener<JSONArray>, ResultDetails {
     ...
     * @param context
     */
    public ResultDetailsUngroupedView(Context context, RMBTMainActivity activity, String uid, JSONArray testResult) {
     ...
     * @param attrs
     */
    public ResultDetailsUngroupedView(Context context, AttributeSet attrs, RMBTMainActivity activity, String uid, JSONArray testResult) {
        super(context, attrs);
    ...
    public void initialize (EndTaskListener<JSONArray>  resultFetchEndTaskListener) {
        ...
        if ((testResultDetailTask == null || testResultDetailTask != null || testResultDetailTask.isCancelled()) && uid != null)
        {
            if (this.testResult!=null) {
                ...
                testResultDetailTask = new CheckTestResultDetailTask(activity, ResultDetailsView.ResultDetailType.SPEEDTEST);
