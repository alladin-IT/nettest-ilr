...
public class QoSTestDetailView extends ScrollView {
	...
	public View createView(LayoutInflater inflater, ViewGroup container) {
        ...
        if (successList.size() > 0) {            
        	successListAdapter = new SimpleAdapter(activity, successList, R.layout.qos_test_view_desc_item, new String[] {
        ...
        if (failureList.size() > 0) {
        	...
        	failureListAdapter = new SimpleAdapter(activity, failureList, R.layout.qos_test_view_desc_item, new String[] {
            "name"}, new int[] { R.id.name });
